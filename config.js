...
global.owner= process.env.OWNER_NUMBER ? process.env.OWNER_NUMBER.replace(/[\s+]/g, '') : "237691314735";
...
module.exports = {
  ...
  botname : process.env.BOT_NAME  || "CHEN ZHI LAO",
  ownername:process.env.OWNER_NAME|| "Florian",
