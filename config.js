...
global.THUMB_IMAGE = process.env.THUMB_IMAGE || process.env.IMAGE || "https://i.ibb.co/ZHn1Xd1/IMG-20240802-WA0019.jpg?raw=true" ; // SET LOGO FOR IMAGE 
global.caption = process.env.CAPTION || global.caption || "BERA-V3-MD " 
...
module.exports = {
  ...
  author : process.env.PACK_AUTHER|| "BERA-V3-MD",
  packname: process.env.PACK_NAME || "BERA-V3-MD",
  botname : process.env.BOT_NAME  || "BERA-V3-MD",
